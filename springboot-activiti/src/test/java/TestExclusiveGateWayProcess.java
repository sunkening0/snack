...
public class TestExclusiveGateWayProcess {
    ...
    public void deployementAndStartProcess(){
        ...
        ProcessInstance pi = processEngine.getRuntimeService()//
                .startProcessInstanceByKey("ExclusiveGateWayDemoProcess",map);//使用流程定义的key的最新版本启动流程
    ...
    public void completeTask(){
        ProcessEngine processEngine = ProcessEngines.getDefaultProcessEngine();
        //任务ID
        String taskId = "c08c343f-e0f3-11ea-91e4-1063c85592f7";
